  ...
  return (
    <div className='w-full rounded-xl p-5 border-2 border-neutral-300 space-y-10'>
        ...
        <div className="w-full flex items-center justify-between">
            ...
            <button className="w-fit px-5 py-1.5 bg-red-700 hover:bg-transparent border-2 border-red-700 hover:border-red-700 rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-red-700 ease-in-out duration-300">
                Reserve Seat
            </button>
        </div>
    </div>
